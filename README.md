...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow?style=for-the-badge)](https://github.com/RITHIKKUMARAN/TextMorph_TeamC_Infosys/blob/main/LICENSE)
...
![GitHub Stars](https://img.shields.io/github/stars/RITHIKKUMARAN/TextMorph_TeamC_Infosys?style=social)
![GitHub Forks](https://img.shields.io/github/forks/RITHIKKUMARAN/TextMorph_TeamC_Infosys?style=social)
![GitHub Issues](https://img.shields.io/github/issues/RITHIKKUMARAN/TextMorph_TeamC_Infosys)
![GitHub Last Commit](https://img.shields.io/github/last-commit/RITHIKKUMARAN/TextMorph_TeamC_Infosys)
...
**Streamlit** - Interactive UI Framework for building responsive web applications

**Google Gemini** - Advanced AI Engine for natural language processing

**Python 3.8+** - Backend Language with extensive library support

**gTTS** - Text-to-Speech conversion in multiple languages

**PyPDF2** - PDF Processing and text extraction capabilities
...
We welcome contributions from the community! Here's how you can help make TextMorph better:

| Contribution Type | How to Help |
|-------------------|-------------|
| 🐛 **Bug Reports** | [Open an issue](https://github.com/RITHIKKUMARAN/TextMorph_TeamC_Infosys/issues) |
| ✨ **Feature Requests** | [Submit your idea](https://github.com/RITHIKKUMARAN/TextMorph_TeamC_Infosys/issues/new) |
| 🔧 **Code Contributions** | [Create a pull request](https://github.com/RITHIKKUMARAN/TextMorph_TeamC_Infosys/pulls) |
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/RITHIKKUMARAN/TextMorph_TeamC_Infosys/blob/main/LICENSE) file for complete details.
...
- **Streamlit team** for the amazing framework and community support
...
Give a ⭐️ if this project helped you! Your support motivates us to keep improving TextMorph.

### 📈 Project Stats

![GitHub Repo Size](https://img.shields.io/github/repo-size/RITHIKKUMARAN/TextMorph_TeamC_Infosys)
![GitHub Contributors](https://img.shields.io/github/contributors/RITHIKKUMARAN/TextMorph_TeamC_Infosys)
![GitHub Commit Activity](https://img.shields.io/github/commit-activity/m/RITHIKKUMARAN/TextMorph_TeamC_Infosys)
